...
const productsModel = {
  ...
  addProduct: (body) => {
    return new Promise((resolve, reject) => {
      ...
      let postQuery = `INSERT INTO products_table SET product_name='${name}', product_price=${price},product_image='${product_image}',category_id=${category_id},product_stock=${0}`;
  ...
  deleteProduct: (params, body) => {
    return new Promise((resolve, reject) => {
      ...
      dbConnect.query(deleteQuery, [Number(id)], (error, result) => {
        if (!error) {
          try {
